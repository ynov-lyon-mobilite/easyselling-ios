...
class RequestGenerator_Specs: XCTestCase {
    ...
    func test_Generates_Request() {
        ...
        givenService()
        whenGenerateRequest(endpoint: "https://easyselling.maxencemottard.com/api/v1/users/profile", method: .POST, headers: [:])
    ...
    func test_Generates_Request_With_Body() {
        ...
        givenService()
        whenGenerateRequestWithBody(endpoint: "https://easyselling.maxencemottard.com/api/v1/users/profile", method: .POST,
                                    body: body, headers: [:])
...
//    }
    ...
    private func whenGenerateRequestWithBody<T: Encodable>(endpoint: String, method: HTTPMethod, body: T, headers: [String: String]) {
