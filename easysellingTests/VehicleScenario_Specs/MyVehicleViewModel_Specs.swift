...
class MyVehiclesViewModel_Specs: XCTestCase {
    ...
    func test_Shows_vehicles_when_request_is_success() async {
        let expectedVehicles = [VehicleInformations(id: "1", brand: "Peugeot", model: "model1", license: "license1", type: .car, year: "year1"),
        ...
        thenLoadVehicles(are: [VehicleInformations(id: "1", brand: "Peugeot", model: "model1", license: "license1", type: .car, year: "year1"),
                               VehicleInformations(id: "2", brand: "Renault", model: "model2", license: "license2", type: .car, year: "year2")])
    ...
    private func thenLoadVehicles(are expected: [VehicleInformations]) {
